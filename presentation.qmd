...
[https://github.com/richelbilderbeek/](https://github.com/richelbilderbeek/score_flash_talk_2026) [score_flash_talk_2026](https://github.com/richelbilderbeek/score_flash_talk_2026)
...
![](monologues_are_the_best_way_to_teach.jpg)
...
## Ideas versus the literature 1/2

Idea                             |Literature
-----------------|---------------------------------------------
Lecturing is effective           |No, it **hinders** learning, more than students feeling disliked `[Hattie, 2023]` <!-- page 363, effect size is -0.26 with a robustness index of 4 out of 5 and is based on 3 meta analyses using 273 studies using 27,296 people, measuring for 614 effects with a standard error of 0.08. -->
...
## Ideas versus the literature 2/2
...
- I have given my ideas on teaching that is relevant for us and how to act on those
- Feel free to ignore
- Feel encouraged to challenge my ideas (in the right time and place)
